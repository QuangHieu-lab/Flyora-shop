        ...
        <ul className="space-y-2 px-4">
            ...
            <>
              <li>
                <a
                  ...
                  className={`flex items-center px-4 py-3 rounded-lg ${location.pathname === "/admin-page/users"
              ...
              <li>
                <a
                  ...
                  className={`flex items-center px-4 py-3 rounded-lg ${location.pathname === "/admin-page/contents"
                      ? "bg-green-500 text-white"
                      : "text-green-100 hover:bg-green-500 transition-colors"
                    }`}
                >
              ...
              <li>
                <a
                  ...
                  className={`flex items-center px-4 py-3 rounded-lg ${location.pathname === "/admin-page/user-activity-log"
                      ? "bg-green-500 text-white"
                      : "text-green-100 hover:bg-green-500 transition-colors"
                    }`}
                >
            ...
            <>
              <li>
                <a
                  ...
                  className={`flex items-center px-4 py-3 rounded-lg ${location.pathname === "/admin-page/product"
                      ? "bg-green-500 text-white"
                      : "text-green-100 hover:bg-green-500 transition-colors"
                    }`}
                >
              ...
              <li>
                <a
                  ...
                  className={`flex items-center px-4 py-3 rounded-lg ${location.pathname === "/admin-page/dashboard"
                      ? "bg-green-500 text-white"
                      : "text-green-100 hover:bg-green-500 transition-colors"
                    }`}
                >
          ...
          <li>
            <button
              ...
              className={`w-full text-left flex items-center px-4 py-3 rounded-lg ${location.pathname === "/"
                  ? "bg-green-500 text-white"
